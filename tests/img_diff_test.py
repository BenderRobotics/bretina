...
print("{:32}: {}".format("tank x tank", bretina.img_diff(tank, tank_template)))
print("{:32}: {}".format("tank x tank", bretina.img_diff(tank_white, tank_template)))
...
print("{:32}: {}".format("quiet x quit", bretina.img_diff(item_11, item_11_src)))
...
print("{:32}: {}".format("floor x floor", bretina.img_diff(item_2, item_2_src)))
...
print("{:32}: {}".format("floor x wall", bretina.img_diff(item_2, item_2_src)))
...
print("{:32}: {}".format("dhw x dhw", bretina.img_diff(item_2, item_2_src, inv=False, bgcolor="#E4F4FF")))
...
print("{:32}: {}".format("drt x drt", bretina.img_diff(item_2, item_2_src, bgcolor="#E4F4FF")))
...
print("{:32}: {}".format("drt x ert", bretina.img_diff(item_2, item_2_src, bgcolor="#E4F4FF")))
...
print("{:32}: {}".format("radiator x radiator", bretina.img_diff(item_2, item_2_src, bgcolor="#E4F4FF")))
...
print("{:32}: {}".format("radiator x ufh", bretina.img_diff(item_2, item_2_src, edges=True, bgcolor="#E4F4FF")))

#
item_2 = cv2.imread('images/ufh.jpg', cv2.IMREAD_UNCHANGED)
item_2_src = cv2.imread('images/img/homescreen/underfloor_heating_alpha.png', cv2.IMREAD_UNCHANGED)
item_2_src = bretina.resize(item_2_src, 3)
...
print("{:32}: {}".format("radiator x fancoil", bretina.img_diff(item_2, item_2_src, edges=True, bgcolor="#E4F4FF")))
...
print("{:32}: {}".format("ou4 x ou4", bretina.img_diff(item_2, item_2_src, bgcolor="#000")))
...
print("{:32}: {}".format("mallfunction x error", bretina.img_diff(mallfunction, error)))
print("{:32}: {}".format("mallfunction x profile", bretina.img_diff(mallfunction, profile)))
print("{:32}: {}".format("user x error", bretina.img_diff(user, error)))
print("{:32}: {}".format("user x profile", bretina.img_diff(user, profile)))

print("{:32}: {}".format("mallfunction x mallfunction", bretina.img_diff(mallfunction, mallfunction)))
print("{:32}: {}".format("error x error", bretina.img_diff(error, error)))
print("{:32}: {}".format("user x user", bretina.img_diff(user, user)))
print("{:32}: {}".format("profile x profile", bretina.img_diff(profile, profile)))
...
for i in range(0, len(imgs)):
    ...
    print("{:32}: {}".format(imgs[i] + " x heat/cool", bretina.img_diff(img, h_c_ico)))
    print("{:32}: {}".format(imgs[i] + " x cooling", bretina.img_diff(img, cooling)))
    print("{:32}: {}".format(imgs[i] + " x heating", bretina.img_diff(img, heating)))
    print("{:32}: {}".format(imgs[i] + " x on off", bretina.img_diff(img, on_off)))
    print("{:32}: {}".format(imgs[i] + " x info", bretina.img_diff(img, info)))
    print("{:32}: {}".format(imgs[i] + " x set", bretina.img_diff(img, set_ico)))
    print("")
