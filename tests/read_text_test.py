...
scale = 3.0
# in the circle
img = cv2.imread('191108/2019-11-08_09-07-10___main__.TestHomeScreen.test_item12.png')
box = [425, 145, 470, 190]
img2_1 = bretina.crop(img, box, scale, 16)
text = bretina.read_text(img2_1, floodfill=True, bgcolor="white", chars="%d")
print(text)
...
# in the circle
img = cv2.imread('191108/2019-11-08_16-44-12___main__.TestHomeScreen.test_item12-src.png')
box = [420, 140, 475, 195]
img2_1 = bretina.crop(img, box, scale, 16)
text = bretina.read_text(img2_1, bgcolor="white", chars="%d", floodfill=True)
print(text)
cv2.imshow(text, img2_1)
cv2.waitKey()
cv2.destroyAllWindows()
...
# in the circle
img = cv2.imread('191108/2019-11-08_16-44-32___main__.TestHomeScreen.test_item12-src.png')
box = [420, 140, 475, 195]
img2_1 = bretina.crop(img, box, scale, 16)
text = bretina.read_text(img2_1, bgcolor="white", chars="%d", floodfill=True)
print(text)
